/* Verilog netlist generated by SCUBA ispLever_v81_SP1_Build (36) */
/* Module Version: 1.0 */
/* C:\ispTOOLS8_1\ispfpga\bin\nt\scuba.exe -w -n ufm -lang verilog -synth synplify -bus_exp 7 -bb -type efb -arch xo2c00 -freq 24 -ufm -ufm_ebr 511 -mem_size 1 -ufm_0 -dev 1200 -e  */
/* Fri Oct 15 15:12:42 2010 */


`timescale 1 ns / 1 ps
module ufm (wb_clk_i, wb_rst_i, wb_cyc_i, wb_stb_i, wb_we_i, wb_adr_i, 
    wb_dat_i, wb_dat_o, wb_ack_o, wbc_ufm_irq);
    input wire wb_clk_i;
    input wire wb_rst_i;
    input wire wb_cyc_i;
    input wire wb_stb_i;
    ...
    defparam EFBInst_0.UFM_INIT_START_PAGE = 511 ;
